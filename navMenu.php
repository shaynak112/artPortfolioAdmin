          ...
          <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul id="active" class="nav navbar-nav side-nav">
                    ...
                    <li><a href="removeImage.php"><i class="fa fa-remove"></i> Remove Image</a></li>
                    <li><a href="analytics.php"><i class="fa fa-info"></i> Analytics</a></li>
                    <li><a href="http://webmail.davidjunk.com/" target='_blank'><i class="fa fa-envelope"></i> Email</a></li>
                </ul>
